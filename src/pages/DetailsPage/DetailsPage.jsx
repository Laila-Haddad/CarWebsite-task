      ...
      {!error && car.name && !loading ? (
        <div className="product-details">
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            <img className="product-img" src={`/${currentImage}`} alt={car.name} />
            <div className="product-media">
              <ImageSlider items={car.images} display="detail" handleImage={handleImage} />
            </div>
          </div>
          <div className="product-info-details">
            <h5 style={{ color: "black" }}>Details</h5>
            <div>
              <ProductInfoSection rating={car.rating} description={car.description} />
            </div>
            <div>
        ...
        <div className="productPage"><Spinner /></div>
      )}
    </>
  );
